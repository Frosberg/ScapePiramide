...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida:\n\nBelén, ya van casi 2 meses desde que apareciste en mi vida, y sinceramente siento que el tiempo ha pasado volando porque contigo todo es diferente.\n\nA pesar de la distancia entre Perú y Chile, logras estar cerca con cada mensaje, con cada risa y con cada momento que compartimos.\n\nGracias por hacer mis días más especiales, eres una persona increíble y me alegra muchísimo haberte conocido.`;  } else {
